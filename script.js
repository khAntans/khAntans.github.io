...
class InputController {
    ...
    onMouseMove_(e) {
        ...
        this.current_.mouseXDelta = this.current_.mouseX - this.previous.mouseX;
        this.current_.mouseYDelta = this.current_.mouseY - this.previous.mouseY;
    }
...
class FirstPersonCamera {
    ...
    updateTranslation(timeElapsed) {
        ...
        strafe.multiplyScalar(strafeVelocity * timeElapsed * 10);
    ...
    updateRotation(timeElapsed) {
        const xh = this.input.current_.mouseXDelta / window.innerWidth;
        const yh = this.input.current_.mouseYDelta / window.innerHeight;

        this.phi += -xh * this.phiSpeed_;
        this.theta = clamp(this.theta + -yh * this.thetaSpeed_, -Math.PI / 3, Math.PI / 3);
